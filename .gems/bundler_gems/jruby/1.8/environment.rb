...
module Bundler
 ...
 dir = File.dirname(file)
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/jruby-jars-1.4.1/lib")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/appengine-rack-0.0.9/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/appengine-apis-0.0.16/lib")
